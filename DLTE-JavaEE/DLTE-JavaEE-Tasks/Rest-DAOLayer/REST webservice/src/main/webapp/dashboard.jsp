    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myBankMenu">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a href="viewTransactions.jsp" class="btn btn-outline-white rounded-5 me-2" style="font-weight: bolder"><span class="bi bi-list-columns"></span> View By type and User</a>
                </li>
                <li class="nav-item">
