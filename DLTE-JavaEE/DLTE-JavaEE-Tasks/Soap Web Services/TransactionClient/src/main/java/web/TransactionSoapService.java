 ...
 * 
 */
@WebServiceClient(name = "TransactionSoapService", targetNamespace = "http://web/", wsdlLocation = "http://localhost:2002/ankitha?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:2002/ankitha?wsdl");
