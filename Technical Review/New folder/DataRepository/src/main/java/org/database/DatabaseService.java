    ...
    public EmployeeDetails getEmployeeById(int id)  {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                String thouse = resultSet.getString(7);
                String tstreet = resultSet.getString(8);
                String tcity = resultSet.getString(9);
                String tstate = resultSet.getString(10);
                String tpin = resultSet.getString(11);
                String phouse = resultSet.getString(13);
                String pstreet = resultSet.getString(14);
                String pcity = resultSet.getString(15);
                String pstate = resultSet.getString(16);
                String ppin = resultSet.getString(17);
