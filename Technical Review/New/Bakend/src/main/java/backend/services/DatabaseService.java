...
import backend.middleware.Activity;
import backend.middleware.AddressDetails;
import backend.middleware.EmployeeDetails;
...
//    EmployeeDetails employeeDetails;
    ...
    @Override
    public void addPermanentAddressDetails(AddressDetails permanentAddressDetails) {
            try{
                String query = "insert into permanent_address_details values(?,?,?,?,?,?)";
                preparedStatement=connection.prepareStatement(query);
                preparedStatement.setString(1,permanentAddressDetails.getPermanentHouseNumber());
                preparedStatement.setString(2,permanentAddressDetails.getPermanentStreetAddress());
                preparedStatement.setString(3,permanentAddressDetails.getPermanentCityName());
                preparedStatement.setString(4,permanentAddressDetails.getPermanentState());
                preparedStatement.setString(5,permanentAddressDetails.getPermanentAddressPin());
    ...
    @Override
    public void addTemporaryAddressDetails(AddressDetails temporaryAddressDetails) {
        try {
            String query1="insert into temporary_address_details values(?,?,?,?,?,?)";
            preparedStatement=connection.prepareStatement(query1);
            preparedStatement.setString(1,temporaryAddressDetails.getTemporaryHouseNumber());
            preparedStatement.setString(2,temporaryAddressDetails.getTemporaryStreetAddress());
            preparedStatement.setString(3,temporaryAddressDetails.getTemporaryCityName());
            preparedStatement.setString(4,temporaryAddressDetails.getTemporaryState());
            preparedStatement.setString(5,temporaryAddressDetails.getTemporaryAddressPin());
            preparedStatement.setInt(6,employeeId);
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            e.printStackTrace();
