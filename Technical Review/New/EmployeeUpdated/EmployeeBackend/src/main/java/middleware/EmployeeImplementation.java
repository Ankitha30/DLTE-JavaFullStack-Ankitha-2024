...
import employee.operations.EmployeeActivities;
...
public class EmployeeImplementation implements EmployeeActivities {
    ...
    @Override
        ...
        public void addEmployeePersonalDetails(PersonalDetails personalDetails)
        {
            ...
            //employee_id number primary key,first_name varchar(255),middle_name varchar(255),last_name varchar(255),email varchar(255),mobile_number number);
            try{
